...
# Plotting graph to png deivce
png(file="plot4.png", height=480,width=480)

# Constructing plot from the available data.

# In this plot we are plotting Global_active_power against 
# DateTime(1 minute sampling for 2 days). The type is line 
# instead of default open circle.
par(mfcol=c(2,2))
...
# In this plot we are plotting Voltage against 
# DateTime(1 minute sampling for 2 days). The type is line 
# instead of default open circle.
with(twoDaysData, plot(DT, as.numeric(Voltage), type="l",
                       col = "black",
                       xlab= "datetime",
                       ylab="Voltage"))


# In this plot we are plotting Global_reactive_power against 
# DateTime(1 minute sampling for 2 days). The type is line 
# instead of default open circle.
with(twoDaysData, plot(DT, as.numeric(Global_reactive_power), type="l",
                       col = "black",
                       xlab= "datetime",
